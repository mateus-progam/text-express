...
(() => {
  ...
  TextExpressApp.prototype.createLegacySemGerenciaFlow = function (legacyItems) {
    ...
    return this.normalizeSnippet({
      ...
      ativo: true,
      origem: "Script chat MATEUS.docx",
      triggerKey: "space",
      etapas: [
        {
